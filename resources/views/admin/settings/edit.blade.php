...
@section('content')
    <form action="{{ route('admin.settings.update') }}" method="POST" class="rounded-lg border border-[#e5ded0] bg-white p-6 shadow-sm">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <x-admin.field label="Delivery charge"><input name="delivery_charge" value="{{ old('delivery_charge', $settings['delivery_charge'] ?? 80) }}" class="rounded-lg border border-[#ddd4c4] px-4 py-3" placeholder="Delivery charge"></x-admin.field>
